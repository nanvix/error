...
A dependency-free library for error codes in POSIX systems.

This library is used by the Nanvix operating system to encode both kernel and user-space errors.
